...
if (isset($_POST['change_password'])) {
    ...
    if (password_verify($current_password, $user['password'])) {
        ...
        $error_password = "Password lama tidak valid!";
    }
}
?>
            ...
            <div class="profile-header shadow-sm">
                <div class="profile-info">
                    ...
                    <div class="profile-meta">
                        ...
                        <p><i class="fas fa-id-badge me-2"></i><?php echo ($user['role'] == 'staff_bk') ? 'Staff BK' : 'Kepala Sekolah'; ?></p>
                                    ...
                                    <form method="POST" action="">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="role" value="<?php echo ($user['role'] == 'staff_bk') ? 'Staff BK' : 'Kepala Sekolah'; ?>" readonly disabled>
                                            </div>
                                        </div>
                                        <div class="mb-3">
