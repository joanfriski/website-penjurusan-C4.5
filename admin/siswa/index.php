                ...
                <div class="card-body">
                    ...
                    <nav aria-label="Page navigation" class="mt-4">
                        <ul class="pagination justify-content-center">
                            <?php if ($page > 1): ?>
                                <li class="page-item">
                                    <a class="page-link" href="?page=<?php echo $page-1; ?><?php echo !empty($search) ? '&search='.urlencode($search) : ''; ?><?php echo !empty($filter_kelas) ? '&kelas='.$filter_kelas : ''; ?>">
                            ...
                            if ($start_page > 1) {
                                echo '<li class="page-item"><a class="page-link" href="?page=1'.(!empty($search) ? '&search='.urlencode($search) : '').(!empty($filter_kelas) ? '&kelas='.$filter_kelas : '').'">1</a></li>';
                                if ($start_page > 2) {
                            ...
                            for ($i = $start_page; $i <= $end_page; $i++): ?>
                                <li class="page-item <?php echo $i == $page ? 'active' : ''; ?>">
                                    <a class="page-link" href="?page=<?php echo $i; ?><?php echo !empty($search) ? '&search='.urlencode($search) : ''; ?><?php echo !empty($filter_kelas) ? '&kelas='.$filter_kelas : ''; ?>">
                                        <?php echo $i; ?>
                                    </a>
                                </li>
                            <?php endfor;
                            ...
                            if ($end_page < $total_page) {
                                ...
                                echo '<li class="page-item"><a class="page-link" href="?page='.$total_page.(!empty($search) ? '&search='.urlencode($search) : '').(!empty($filter_kelas) ? '&kelas='.$filter_kelas : '').'">'.$total_page.'</a></li>';
                            }
                            ?>
