...
if (isset($_POST['submit'])) {
    ...
    $status = 'aktif'; // Status default langsung diset "aktif" karena field sudah disembunyikan
    ...
    if (empty($errors)) {
        $insert_query = "INSERT INTO siswa (nis, nisn, nama_lengkap, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, no_telp, kelas_id, status) 
                        VALUES ('$nis', '$nisn', '$nama_lengkap', '$jenis_kelamin', '$tempat_lahir', '$tanggal_lahir', '$alamat', '$no_telp', '$kelas_id', '$status')";
        
        $result = mysqli_query($conn, $insert_query);
        
        if ($result) {
            // Log aktivitas penambahan siswa
            $user_id = $_SESSION['user_id'];
            $log_query = "INSERT INTO log_aktivitas (user_id, aktivitas, keterangan, ip_address) 
                         VALUES ('$user_id', 'Menambahkan data siswa', 'Nama: $nama_lengkap, NIS: $nis', '".$_SERVER['REMOTE_ADDR']."')";
            ...
            $_SESSION['error'] = "Gagal menambahkan data siswa: " . mysqli_error($conn);
        }
    }
}
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 content-wrapper" id="content">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h2 class="h3">
                    <i class="fas fa-user-plus me-2 text-primary"></i>Tambah Siswa
                </h2>
                <div class="btn-toolbar mb-2 mb-md-0">
    <a href="import_siswa.php" class="btn btn-sm btn-success me-2">
        ...
        <i class="fas fa-arrow-left me-1"></i> Kembali
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white">
                    <h5 class="mb-0">
                        <i class="fas fa-wpforms me-2 text-primary"></i>Form Tambah Siswa
                    </h5>
                    <small class="text-muted">Silakan isi data siswa dengan lengkap dan benar</small>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nis" name="nis" required 
                                           placeholder="Masukkan NIS" value="<?php echo isset($_POST['nis']) ? $_POST['nis'] : ''; ?>">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nisn" name="nisn" required 
                                           placeholder="Masukkan NISN" value="<?php echo isset($_POST['nisn']) ? $_POST['nisn'] : ''; ?>">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" required 
                                           placeholder="Masukkan nama lengkap" value="<?php echo isset($_POST['nama_lengkap']) ? $_POST['nama_lengkap'] : ''; ?>">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" 
                                           placeholder="Masukkan tempat lahir" value="<?php echo isset($_POST['tempat_lahir']) ? $_POST['tempat_lahir'] : ''; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="alamat" name="alamat" rows="3" 
                                              placeholder="Masukkan alamat lengkap"><?php echo isset($_POST['alamat']) ? $_POST['alamat'] : ''; ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="no_telp" name="no_telp" 
                                               placeholder="Masukkan nomor telepon" value="<?php echo isset($_POST['no_telp']) ? $_POST['no_telp'] : ''; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        
                        <!-- Field status disembunyikan dan langsung diisi dengan nilai default 'aktif' -->
